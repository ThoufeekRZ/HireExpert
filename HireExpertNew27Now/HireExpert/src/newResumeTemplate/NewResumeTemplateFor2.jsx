...
const NewResumeTemplateFor2 = ({popUpResume,setPopUpResume}) => {
            ...
            <div className="temp-match-details">
              ...
              <div className="temp-current-status">
                ...
                <span className={`temp-status-badge-small ${popUpResume.status === 'New' ? 'temp-status-new' :
                    popUpResume.status === 'Interview' ? 'temp-status-reviewed' :
                      popUpResume.status === 'InterviewConfirmed' ? 'temp-status-shortlisted' :
                        popUpResume.status === 'Rejected' ? 'temp-status-rejected' :
                          'temp-status-interview'
                  }`}>
                  {popUpResume.status === "Interview" ? "Pending" : popUpResume.status }
                </span>
              </div>
            </div>
          </div>
...
export default NewResumeTemplateFor2